...
Для того, чтобы начать редактировать соответствующий блок, необходимо его выбрать, удерживая клавишу `Alt (Option)`. Блок, открытый в режиме редактирования, выделяется красной сплошной обводкой и представляет собой html-код. Редактируемые блоки могут содержать как текст, так и html или PHP-код.
