...
Реализует шаблон представления данных. Может быть расположен в нескольких субдиректориях, включая множественную вложенность, для создания разных видов представлений для соответствующих этой вложенности запросов URI.
